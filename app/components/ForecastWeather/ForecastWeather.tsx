        ...
        <>
            {loading ? (
                ...
                <div className="w-[95%] px-[0.4rem] grid grid-cols-1 md:grid-cols-3 gap-6">
                    <h2 className="md:col-span-3 lg:text-4xl sm:text-3xl text-2xl py-[1rem]">Next 3 days weather in {error !== null ? (lastCity ?? forecastWeather?.location.name) : (userInput ?? lastCity ?? forecastWeather?.location.name)}</h2>
                    {/* 
